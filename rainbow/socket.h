#ifndef __RAINBOW_SOCKET_H__
#define __RAINBOW_SOCKET_H__
...
public:
    ...
    static Socket::ptr CreateTCP(rainbow::Address::ptr address);
    static Socket::ptr CreateUDP(rainbow::Address::ptr address);
...
#endif /* ifndef __RAINBOW_SOCKET_H__ */
